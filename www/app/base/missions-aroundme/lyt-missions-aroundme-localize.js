...
function(Marionette, i18n) {
	...
	return Marionette.LayoutView.extend({
		template: 'www/app/base/missions-aroundme/tpl-missions-aroundme-localize.html',
	    ...
	    onPositionSucess: function(position) {
			...
			self.app.user.set('departements', selectedDepartements.pluck('code'));
			self.app.user.set('position', {
                lat: lat,
                lon: lon
            });
            self.app.user.save();
